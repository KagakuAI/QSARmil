...
class RDKitGEOM(RDKitDescriptor3D):
    ...
    Computes descriptors such as asphericity, eccentricity, PMI, radius of gyration, etc.
    """

    def __init__(self):
        """Initialize the RDKitGEOM descriptor with a fixed list of geometric descriptors."""
        super().__init__()
